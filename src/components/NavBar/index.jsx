...
const NavBar = () => {
    const [user, setUser] = useState(null); // User state to track login/logout status
    ...
    return (
        <div>
            <header>
                <div className="flex justify-between items-center h-[50px] px-8">
                    ...
                    <div className="flex gap-4 items-center">
                        <h6>Store</h6>
                        <h6>Wish List</h6>
                        {/* Dynamic button for Log In / Log Out */}
                        <button
                            className="bg-gray-800 text-white border-none py-2 px-6 rounded-md text-[12px] hover:bg-gray-700"
            ...
            <nav className="mt-4 flex justify-between py-2 px-8 border-t border-gray-300 border-b border-gray-800">
                <a
                    href="#new-arrivals"
                    className="py-1 px-4 text-gray-600 text-[14px] font-medium"
                >
                    New Arrivals
                </a>
                <a
                    href="#fresh"
                    className="py-1 px-4 text-white bg-red-500 rounded-md text-[14px] font-medium"
                >
                    #Fresh
                </a>
                <a
